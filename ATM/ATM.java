...
class Withdraw100 implements WithdrawChain{
	...
	public void withdraw(Amount amt,HashMap<Integer,Integer> notes,HashMap<Integer,Integer> counter){
		...
		//pass remaining amount to next note
		if(remainder != 0){
			if(notes.get(2000)!=0){
				System.out.println("Enter amount in multiple of 2000");
			}
			if(notes.get(500)!=0){
				System.out.println("Enter amount in multiple of 500");
			}
			if(notes.get(200)!=0){
				System.out.println("Enter amount in multiple of 200");
			}
			if(notes.get(100)!=0){
			...
			if(counter.get(2000)>0)
				System.out.println("Dispensing "+counter.get(2000)+" notes of 2000");
			if(counter.get(500)>0)
				System.out.println("Dispensing "+counter.get(500)+" notes of 500");
			if(counter.get(200)>0)
				System.out.println("Dispensing "+counter.get(200)+" notes of 200");
			if(counter.get(100)>0)
				System.out.println("Dispensing "+counter.get(100)+" notes of 100");
			
			//change in number of notes in the ATM
